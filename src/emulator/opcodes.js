app.service('opcodes', [function() {
	...
	IRET: 98,
        ...
        MUL_BYTE_REG: 160,
        MUL_BYTE_REGADDRESS: 161,
        MUL_BYTE_ADDRESS: 162,
        MUL_BYTE_NUMBER: 163,
        DIV_BYTE_REG: 164,
        DIV_BYTE_REGADDRESS: 165,
        DIV_BYTE_ADDRESS: 166,
        DIV_BYTE_NUMBER: 167,
        AND_BYTE_REG_WITH_REG: 170,
        AND_BYTE_REGADDRESS_WITH_REG: 171,
        AND_BYTE_ADDRESS_WITH_REG: 172,
        AND_BYTE_NUMBER_WITH_REG: 173,
        OR_BYTE_REG_WITH_REG: 174,
        OR_BYTE_REGADDRESS_WITH_REG: 175,
        OR_BYTE_ADDRESS_WITH_REG: 176,
        OR_BYTE_NUMBER_WITH_REG: 177,
        XOR_BYTE_REG_WITH_REG: 178,
        XOR_BYTE_REGADDRESS_WITH_REG: 179,
